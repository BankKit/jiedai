...
<body>
	<div class="main">
	<div class="main_title">P2P网贷<?php echo l("ADMIN_PLATFORM");?> <?php echo L("HOME");?>	</div>
	...
	<table class="form" cellpadding=0 cellspacing=0>
		...
		<tr>
			...
			<td class="item_input">
				总收款<?php echo (format_price($income_amount)); ?>，<br>会员资金<?php echo (format_price($user_amount)); ?>，<br>会员冻结资金<?php echo (format_price($user_lock_amount)); ?>，<br>已提现<?php echo (format_price($carry_amount)); ?>
			</td>
		</tr>
		...
		<tr>
			...
			<td class="item_input">
				请访问 <a href="http://www.fanwe.com" target="_blank" title="方维贷款商业系统">http://www.fanwe.com</a>
			</td>
		</tr>
		<tr>
